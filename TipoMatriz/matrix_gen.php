...
<head>
  ...
  <title>Matriz Personalizada</title>
</head>
<body>
<?php
            ...
            <div class="card">
                ...
                <div class="menu-icons mt-3">
                    <div class="iconos">
                        ...
                        <div title="Inicio" class="mx-2"><a href="#" style="display:none" id="generador" onclick="genera_campos_matriz_1();genera_campos_matriz_2()"><i class="fa-solid fa-right-to-bracket mx-2"></i>Generar Matriz</a></div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <select onchange="ruta();cantidadMatrices()" required style="color:black" name="membership" id="opSel" class="form-select">
