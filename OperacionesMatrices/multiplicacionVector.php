...
<body>
    ...
    function multiplicacionVectores($A,$B){
        ...
        if ($columnas2==$filas2) {
            ...
            echo "<h3>Matriz y Vector son  incompatibles para la multiplicacion</h3>";
        }
        ...
        echo '<div class="card">';
            echo '<div class="circle">';
                echo '<div class="matriz_aleatoriaTitulo">';
                    echo '<h2>Multiplicacion de Matrices por un Vector</h2>';
                echo '</div>';
            echo '</div>';
            ...
            multiplicacionVectores($matriz,$vector);
            echo '</div>';
        echo '</div>';
    echo '</div>';
